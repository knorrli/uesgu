...
#
# The provider is settled by the measurement in
# docs/user-event-capture-provider-evaluation.md:
...
module EventCaptureConfig
  ...
  # transfer to another; see docs/user-event-capture-provider-evaluation.md).
