...
class InboxNarrowViewportTest < ApplicationSystemTestCase
  # Regression for #90: .notification__meta is nowrap so the date range stays
  # flush right, and it used to shove the whole page ~29px wider than the
  # viewport. Locale matters — the overflow only shows in German ("3
  # Veranstaltungen" is far wider than "3 events"), which is the default locale
  # but NOT what a headless browser's Accept-Language asks for.
